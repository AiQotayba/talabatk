            ...
            <View className="bg-blue-50 rounded-xl p-4 w-full mb-6">
              <View className="flex-row items-start gap-3">
                ...
                <View className="flex-1">
                  <Text className="text-blue-900 font-semibold mb-1 text-start">كيفية الاستخدام</Text>
                  <Text className="text-blue-700 text-sm text-start leading-5">
                    يمكن للسائق مسح هذا الرمز للوصول إلى تفاصيل الطلب بسرعة
                  </Text>
                </View>
              </View>
            </View>
